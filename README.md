...
Introduction:
- This is a private osu! standard 1v1 tourney and will only be hosted for No Title discord server, sorry.
...
- If you are not in No Title but you got this link, you can play the tournament if you join No Title discord server (of course before the time registration closes)
